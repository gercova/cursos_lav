                                    ...
                                    <td class="px-6 py-5 relative" x-data="{ open: false }" :class="{ 'z-30': open }">
                                        <div class="relative flex items-center justify-end">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <!-- Ver secciones -->
                                                <a href="{{ route('admin.courses.sections.index', $course->id) }}" class="block px-4 py-2 text-sm text-indigo-600 hover:bg-indigo-50 flex items-center gap-2">
                                                ...
                                                <!-- Cambiar estado -->
                                                <button @click="toggleCourseStatus({{ $course->id }}); open = false" class="w-full text-left px-4 py-2 text-sm flex items-center gap-2 hover:bg-{{ $course->is_active ? 'amber' : 'green' }}-50 text-{{ $course->is_active ? 'amber' : 'green' }}-600">
                                                    @if ($course->is_active)
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <!-- Editar -->
                                                <a href="{{ route('admin.courses.edit', $course) }}" class="block px-4 py-2 text-sm text-blue-600 hover:bg-blue-50 flex items-center gap-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        function courseManager() {
            return {
                ...
                // Nueva estructura para el modal de precios
                priceModal: {
                    show: false,
                    courseId: null,
                    courseTitle: '',
