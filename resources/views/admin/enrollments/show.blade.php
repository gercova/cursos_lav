                        ...
                        <div class="ml-6 flex-1">
                            ...
                            <div class="mt-4 grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <p class="font-medium">{{ $enrollment->course->category->name ?? 'Sin categoría' }}</p>
                                </div>
                                <div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-sm font-semibold">S/ {{ number_format($payment->amount, 2) }}</td>
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            ...
                            <select id="statusSelect" class="w-full px-3 py-2 border border-gray-300 rounded-md mb-3">
                                <option value="active" {{ $enrollment->status == 'active' ? 'selected' : '' }}>Activo</option>
                                <option value="completed" {{ $enrollment->status == 'completed' ? 'selected' : '' }}>Completado</option>
                                <option value="cancelled" {{ $enrollment->status == 'cancelled' ? 'selected' : '' }}>Cancelado</option>
                                <option value="pending" {{ $enrollment->status == 'pending' ? 'selected' : '' }}>Pendiente</option>
                            </select>
