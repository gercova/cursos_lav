...
class UserValidate extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'colegial'          => 'nullable|string|max:20',
            'colegial_type'     => 'nullable|string|max:20',
    ...
    public function messages(): array {
        return [
            ...
            'colegial.max'          => 'La colegiatura tiene una longitud máxima de 20 caracteres',
            'colegial_type.max'     => 'El tipo de colegiatura tiene una longitud máxima de 20 caracteres',
