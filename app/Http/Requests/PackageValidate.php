...
class PackageValidate extends FormRequest {
    ...
    public function messages(): array {
        return [
            ...
            'plan_type_id.required'                     => 'El Tipo de Plan es obligatorio',
            ...
            'seats_min.required'                        => 'El campo asientos mínima es obligatorio.',
            'seats_max.required'                        => 'El campo asientos máxima es obligatorio.',
            'seats_min.integer'                         => 'La cantidad de asientos mínima debe ser un número entero.',
            'seats_max.integer'                         => 'La cantidad de asientos máxima debe ser un número entero.',
            'seats_min.min'                             => 'Debe haber al menos 1 asiento disponible.',
            'seats_max.min'                             => 'Debe haber al menos 1 asiento disponible.',
            'is_active.boolean'                         => 'El estado debe ser verdadero o falso.',
            'meta_description.max'                      => 'La meta descripción no puede exceder los 500 caracteres.',
