        ...
        <div id="cookie-consent-banner" class="fixed bottom-0 left-0 right-0 bg-gray-900 text-white p-4 shadow-2xl z-50 transform translate-y-full transition-transform duration-300">
            <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="text-center md:text-left">
                    <h4 class="font-semibold text-base sm:text-lg mb-1">Usamos Cookies</h4>
                    <p class="text-gray-300 text-xs sm:text-sm">
                        Utilizamos cookies para mejorar la experiencia. Gestione sus preferencias en nuestra <a href="#cookies-tab" class="text-amber-400 hover:text-amber-300 underline">Política</a>.
                    </p>
                </div>
                <div class="flex flex-wrap justify-center sm:justify-end gap-2 w-full md:w-auto">
                    <button id="cookie-reject" class="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-600 rounded-lg text-xs sm:text-sm font-medium hover:bg-gray-800 transition-colors">
                        Rechazar
                    </button>
                    <button id="cookie-settings" class="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-amber-600 text-amber-400 rounded-lg text-xs sm:text-sm font-medium hover:bg-amber-900 transition-colors">
                        Personalizar
                    </button>
                    <button id="cookie-accept" class="w-full sm:w-auto px-4 py-2 bg-amber-600 hover:bg-amber-700 rounded-lg text-xs sm:text-sm font-medium transition-colors">
                        Aceptar Todas
                    </button>
                </div>
            </div>
...
<script>
    ...
    setTimeout(() => { if (!localStorage.getItem('cookie-consent')) cookieBanner.classList.remove('translate-y-full'); }, 2000);
