            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    <input type="text" id="search-certificates"
                           ...
                           class="pl-10 pr-4 py-2.5 w-full sm:w-64 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
    ...
    @if($certificates->count() > 0)
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="certificate-item px-6 py-5 hover:bg-gray-50/80 transition-colors duration-200"
                     data-name="{{ strtolower($certificate->course->title) }}"
                     data-date="{{ $certificate->issue_date->timestamp }}">
                        ...
                        <div class="col-span-3 lg:col-span-2">
                            <div class="text-center">
                                <div class="inline-flex items-center px-3 py-1.5 rounded-lg bg-gray-100 border border-gray-200">
                                    ...
                                    <button onclick="copyToClipboard('{{ $certificate->getFormattedCertificateNumber() }}', this)"
                                            class="ml-2 text-gray-400 hover:text-blue-600 transition-colors duration-200"
                                            title="Copiar número">
                        ...
                        <div class="col-span-4 lg:col-span-2">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <a href="{{ route('student.certificates.show', $certificate->id) }}"
                                   class="action-btn group" title="Ver certificado">
                                ...
                                <a href="{{ route('student.certificates.download', $certificate->id) }}"
                                   class="action-btn group" title="Descargar PDF">
                                ...
                                <a href="{{ $certificate->verification_url }}"
                                   target="_blank" class="action-btn group" title="Verificar certificado">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    <button @click="open = !open"
                                            class="action-btn group" title="Compartir">
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <a href="javascript:void(0);"
                                           onclick="shareCertificate('{{ $certificate->getFormattedCertificateNumber() }}', '{{ $certificate->course->title }}', '{{ $certificate->verification_url }}')"
                                           class="share-option flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
                                            <i class="fab fa-whatsapp text-green-500 mr-3 text-base"></i>
                                            Compartir por WhatsApp
                                        </a>
                                        <a href="mailto:?subject=Certificado: {{ $certificate->course->title }}&body=Verifica mi certificado: {{ $certificate->verification_url }}"
                                           class="share-option flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
                                            <i class="fas fa-envelope text-red-500 mr-3 text-base"></i>
                                            Compartir por Email
                                        </a>
                                        <button onclick="copyLink('{{ $certificate->verification_url }}')"
                                                class="share-option w-full text-left flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
        ...
        <div class="bg-white rounded-2xl border-2 border-dashed border-gray-300 py-16 px-6 text-center animate-fade-in">
            <div class="max-w-md mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a href="{{ route('cursos') }}"
                       class="inline-flex items-center justify-center px-5 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md">
        ...
        <div class="bg-white rounded-2xl w-full max-w-md mx-4 p-6 transform transition-transform duration-300 scale-95">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <button onclick="closeShareModal()"
                        class="px-4 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200">
                    Cancelar
                </button>
                <button id="confirmShare"
                        class="px-4 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-200">
                    Compartir
                </button>
            </div>
        </div>
