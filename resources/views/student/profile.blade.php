...
@section('content')
    <div class="max-w-7xl mx-auto" x-data="{ activeTab: '{{ (session('success') && str_contains(session('success'), 'código')) || (session('info') && str_contains(session('info'), 'código')) ? 'promo' : 'info' }}' }" x-init="if (activeTab === 'promo') { setTimeout(() => loadPromoQR(), 100); };
    $watch('activeTab', val => { if (val === 'promo') { loadPromoQR(); } })">
        <!-- Header del perfil -->
        <div class="mb-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="flex flex-col items-center mb-6">
                        <div class="relative">
                            <div
                                class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gradient-to-br from-blue-50 to-gray-100">
                                @if ($user->profile_photo)
                                    <img src="{{ Storage::url($user->profile_photo) }}"
                                        alt="Foto de perfil de {{ $user->names }}" class="w-full h-full object-cover">
                                @else
                            ...
                            <form id="profile-photo-form" action="{{ route('student.profile.update-photo') }}"
                    ...
                    <div class="p-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex">
                                            <select name="country_code"
                                                ...
                                                <option value="+51"
                                                    {{ old('country_code', $user->country_code) == '+51' ? 'selected' : '' }}>
                                                    +51 PE</option>
                                                <option value="+1"
                                                    {{ old('country_code', $user->country_code) == '+1' ? 'selected' : '' }}>
                                                    +1 US</option>
                                                <option value="+57"
                                                    {{ old('country_code', $user->country_code) == '+57' ? 'selected' : '' }}>
                                                    +57 CO</option>
                                                <option value="+34"
                                                    {{ old('country_code', $user->country_code) == '+34' ? 'selected' : '' }}>
                                                    +34 ES</option>
                                                <option value="+54"
                                                    {{ old('country_code', $user->country_code) == '+54' ? 'selected' : '' }}>
                                                    +54 AR</option>
                                            </select>
                                    ...
                                    <div>
                                        ...
                                        <select id="nationality" name="nationality"
                                            ...
                                            <option value="Peruana"
                                                {{ old('nationality', $user->nationality) == 'Peruana' ? 'selected' : '' }}>
                                                Peruana</option>
                                            <option value="Colombiana"
                                                {{ old('nationality', $user->nationality) == 'Colombiana' ? 'selected' : '' }}>
                                                Colombiana</option>
                                            <option value="Argentina"
                                                {{ old('nationality', $user->nationality) == 'Argentina' ? 'selected' : '' }}>
                                                Argentina</option>
                                            <option value="Mexicana"
                                                {{ old('nationality', $user->nationality) == 'Mexicana' ? 'selected' : '' }}>
                                                Mexicana</option>
                                            <option value="Española"
                                                {{ old('nationality', $user->nationality) == 'Española' ? 'selected' : '' }}>
                                                Española</option>
                                            <option value="Estadounidense"
                                                {{ old('nationality', $user->nationality) == 'Estadounidense' ? 'selected' : '' }}>
                        ...
                        <div x-show="activeTab === 'password'" x-transition:enter="transition ease-out duration-300"
                            ...
                            <form action="{{ route('student.profile.update-password') }}" method="POST"
                                ...
                                <p class="text-gray-600 mb-6">Asegúrate de usar una contraseña segura que no uses en otros
                                    sitios.</p>
                        ...
                        <div x-show="activeTab === 'privacy'" x-transition:enter="transition ease-out duration-300"
                            ...
                            <p class="text-gray-600 mb-6">Controla cómo otros usuarios ven tu información en la plataforma.
                            </p>
                                ...
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">Permite que otros estudiantes vean tu
                                                perfil</p>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">Comparte tus certificados con otros
                                                estudiantes</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" checked>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">Recibe notificaciones sobre tus cursos
                                            </p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" checked>
                            ...
                            @if (!$user->code)
                                ...
                                <div
                                    ...
                                    <p class="text-gray-600 max-w-md mx-auto mb-6 text-sm">
                                        Genera tu código de promoción único para poder compartir enlaces de afiliados,
                                        promocionar nuestros cursos y generar comisiones por cada compra referida.
                                    </p>
                            ...
                            @else
                                ...
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 mt-1">Comparte tu enlace de afiliación y gana
                                            comisiones recomendando nuestros cursos.</p>
                                    </div>

                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                                        <!-- Columna QR -->
                                        <div
                                            class="flex flex-col items-center p-6 bg-gray-50 border border-gray-200 rounded-2xl">
                                            <div id="promo-qrcode-container"
                                                class="bg-white p-4 rounded-xl border border-gray-300 shadow-sm transition-transform duration-300 hover:scale-105">
                                                <div id="promo-qrcode" class="flex justify-center items-center"
                                        ...
                                        <div class="space-y-6">
                                            <!-- Caja Código -->
                                            <div
                                                class="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl">
                                                <span
                                                    class="text-xs font-semibold text-blue-600 uppercase tracking-wider block mb-1">Mi
                                                    código exclusivo</span>
                                                <div class="flex items-center justify-between">
                                                    <span
                                                        class="text-2xl font-black text-blue-900 font-mono tracking-wider">{{ $user->code }}</span>
                                                    <span
                                                        class="px-2.5 py-1 text-xs font-semibold text-emerald-800 bg-emerald-100 rounded-full">Activo</span>
                                                </div>
                                            </div>

                                            <!-- Campo Enlace -->
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-2">Enlace de
                                                    afiliado</label>
                                                <div class="flex">
                                                    <input type="text" readonly id="promo-link-input"
                                                        value="{{ url('/cursos/' . $user->code) }}"
                                            ...
                                            <!-- Instrucciones -->
                                            <div class="border-t border-gray-200 pt-4">
                                                <h4 class="text-sm font-semibold text-gray-700 mb-2 font-bold">¿Cómo
                                                    funciona?</h4>
                                ...
                                <div
                                    ...
                                    <div class="ml-4 flex-1">
                                        <p class="text-sm font-medium text-gray-900">
                                            {{ $enrollment->course->title ?? 'Curso' }}</p>
                                        <p class="text-xs text-gray-500 mt-1">Inscrito el
                                            {{ $enrollment->created_at->format('d/m/Y') }}</p>
                                    </div>
    ...
    <script>
        ...
        function renderPromoQR() {
            ...
            const promoLink = document.getElementById('promo-link-input')?.value ||
                "{{ url('/cursos/' . ($user->code ?? '')) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnSharePromo) {
                btnSharePromo.addEventListener('click', () => {
                    ...
                    if (canvas && navigator.share && navigator.canShare && HTMLCanvasElement.prototype
                        .toBlob) {
                        canvas.toBlob(blob => {
                            const file = new File([blob], 'mi-qr-promo.png', {
                                type: 'image/png'
                            });
