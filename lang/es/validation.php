...
return [
    ...
    | versiones, como las reglas de tamaño. Siéntete libre de modificar cada uno
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado apareció en una filtración de datos. Por favor, elige un :attribute diferente.',
    ],
    ...
    | usando la convención "atributo.regla" para nombrar las líneas. Esto facilita
    | especificar una línea de lenguaje personalizada específica para una regla de
    | atributo dada.
    |
    */
