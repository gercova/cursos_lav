            ...
            <div class="sidebar-header">
                <div class="flex items-center justify-between">
                    <a href="{{ route('student.dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-semibold text-gray-800 text-sm hidden lg:inline">
                            {{ $enterprise->trade_name }}
                        </span>
                    </a>
                    <button @click="toggleMobileMenu" class="lg:hidden p-2 hover:bg-gray-100 rounded-lg">
                        <i class="bi bi-x-lg text-gray-500 mr-2"></i>
                    </button>
                </div>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                @if ($hasAnyPackage)
                    ...
                    <a href="{{ route('company.list') }}"
                        ...
                        <i class="bi bi-people mr-2"></i> Gestionar mis usuarios
                    </a>
                    <a href="{{ route('company.enroll.users') }}"
                        class="sidebar-link {{ request()->routeIs('company.enroll.*') ? 'active bg-purple-300' : '' }}">
                        <i class="bi bi-person-add mr-2"></i> Inscribir mis usuarios
                    </a>
                    ...
                    @if (auth()->user()->company_code || (auth()->user()->parent && auth()->user()->parent->company_code))
                        <a href="{{ route('company.schedule') }}"
                            ...
                            <i class="bi bi-calendar4-week mr-2 text-blue-500"></i> Programa Anual de Capacitación
                        </a>
                    @endif
                    <hr>
                @else
                ...
                <a href="{{ route('student.exams') }}"
                    ...
                    <i class="bi bi-file-earmark-richtext mr-2"></i>
                    <span>Exámenes</span>
                </a>
            ...
            <div class="header-content">
                <div class="header-left">
                    <button class="menu-toggle" @click="toggleSidebar">
                        <i class="bi " :class="mobileMenuOpen ? 'bi-xW' : 'bi-list'"></i>
                    </button>
                        ...
                        <div x-show="openNotifications" @click.away="openNotifications = false" x-cloak
                            ...
                            <div class="max-h-96 overflow-y-auto divide-y divide-gray-50">
                                ...
                                <div x-show="!notificationsLoading && notifications.length === 0"
                                    ...
                                    <i class="bi bi-bell text-gray-300 text-xl mb-1.5 block"></i>
                    ...
                    @auth
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                ...
                                <i class="bi bi-chevron-down text-xs text-gray-500" :class="{ 'rotate-180': open }"></i>
                            </button>
