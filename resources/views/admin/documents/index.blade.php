    ...
    <div class="container mx-auto px-4 py-6" x-data="documentManager()" x-init="init()">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                ...
                <button @click="$dispatch('open-document-modal', { editing: false })"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-900 mt-1">
                                {{ $documents->where('is_active', true)->count() }}</p>
                        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <div class="flex gap-2">
                            ...
                            <select x-model="courseFilter" @change="performSearch()"
                                class="px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">
                            ...
                            <select x-model="typeFilter" @change="performSearch()"
                                class="px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">
            ...
            <div class="overflow-x-auto md:overflow-visible" id="documents-table-container" x-show="!loading">
                @if ($documents->isEmpty())
                    ...
                    <div class="text-center py-16 px-6">
                        ...
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Comienza subiendo tu primer documento para compartir
                            ...
                            @foreach ($documents as $document)
                                <tr
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="flex-shrink-0">
                                                @switch($document->file_type)
                                                    @case('pdf')
                                                        <div
                                                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                    ...
                                                    @case('docx')
                                                        <div
                                                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                            <svg class="w-7 h-7 text-blue-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="1.5"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                                    ...
                                                    @case('pptx')
                                                        <div
                                                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                    ...
                                                    @case('xlsx')
                                                        <div
                                                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                    ...
                                                    @default
                                                        <div
                                                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                            <svg class="w-7 h-7 text-gray-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="1.5"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                        ...
                                        @if ($document->course)
                                            <div class="flex items-center gap-3">
                                                @if ($document->course->image_url)
                                                    <img src="{{ $document->course->image_url }}"
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="space-y-2">
                                            <div
                                                class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100">
                                    ...
                                    <td class="px-6 py-5">
                                        <div x-data="{ open: false }" class="relative flex items-center justify-end">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <!-- Activar / Desactivar -->
                                                <button @click="toggleDocumentStatus({{ $document->id }}); open = false"
                                                    class="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium {{ $document->is_active ? 'text-amber-600 hover:bg-amber-50' : 'text-emerald-600 hover:bg-emerald-50' }} transition-colors duration-150">
                                                    @if ($document->is_active)
                                                ...
                                                <a href="{{ Storage::url($document->file_path) }}" download
                                                    class="block w-full px-4 py-2.5 text-sm font-medium text-blue-600 hover:bg-blue-50 flex items-center gap-3 transition-colors duration-150">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                <!-- Vista previa -->
                                                <a href="{{ Storage::url($document->file_path) }}" target="_blank"
                                                    class="block w-full px-4 py-2.5 text-sm font-medium text-emerald-600 hover:bg-emerald-50 flex items-center gap-3 transition-colors duration-150">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <a href="{{ route('admin.documents.edit', $document->id) }}"
                                                    class="block w-full px-4 py-2.5 text-sm font-medium text-purple-600 hover:bg-purple-50 flex items-center gap-3 transition-colors duration-150">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                <!-- Eliminar -->
                                                <button @click="deleteDocument({{ $document->id }}); open = false"
            ...
            @if ($documents->hasPages())
                <div id="documents-pagination" class="px-6 py-4 border-t border-gray-200 bg-gray-50/50">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900"
                                        x-text="isEditing ? 'Editar Documento' : 'Subir Nuevo Documento'"></h3>
                                    <p class="text-sm text-gray-600 mt-1"
                                        x-text="isEditing ? 'Actualiza la información del documento' : 'Completa el formulario para subir un nuevo documento'">
                                    </p>
                                </div>
                            ...
                            <form @submit.prevent="submitForm" id="documentForm" enctype="multipart/form-data">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea x-model="formData.description" rows="3" placeholder="Describe el contenido del documento..."
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select x-model="formData.course_id" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">
                                    ...
                                    <div
                                        ...
                                        <div x-show="!isEditing" class="mb-4">
                                            ...
                                            <div
                                                class="border-2 border-dashed border-blue-300 rounded-xl p-6 text-center hover:border-blue-400 transition duration-200">
                                            ...
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    <p class="text-sm font-medium text-gray-900"
                                                        x-text="formData.title + '.' + formData.file_type"></p>
                                                    <p class="text-xs text-gray-500"
                                                        x-text="formatFileSize(formData.file_size)"></p>
                                                </div>
                                                <a :href="'/storage/' + formData.file_path" download
                                                    class="text-blue-500 hover:text-blue-700" title="Descargar">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                ...
                                <div class="flex items-center justify-end gap-4 pt-6 mt-6 border-t border-gray-200">
                                    ...
                                    <button type="submit" :disabled="isSubmitting"
                                        ...
                                        <svg x-show="isSubmitting" class="animate-spin h-5 w-5 text-white" fill="none"
                                            viewBox="0 0 24 24">
                                        ...
                                        <span
                                            x-text="isSubmitting ? 'Guardando...' : (isEditing ? 'Actualizar Documento' : 'Subir Documento')"></span>
                                    </button>
                                </div>
                            </form>
                        </div>
        ...
        function documentManager() {
            return {
                ...
                async performSearch() {
                    ...
                    const displayUrl =
                        `{{ route('admin.documents.index') }}?${params.toString().replace('&ajax=1','').replace('ajax=1&','').replace('ajax=1','')}`;
                    window.history.replaceState(null, '', displayUrl || '{{ route('admin.documents.index') }}');
                    ...
                    try {
                        ...
                        const newTable = doc.getElementById('documents-table-container');
                        if (newTable) document.getElementById('documents-table-container').innerHTML = newTable
                            .innerHTML;

                        const newPag = doc.getElementById('documents-pagination');
                        const curPag = document.getElementById('documents-pagination');
                ...
                async submitForm() {
                    ...
                    try {
                        ...
                        if (this.isEditing) {
                            ...
                            url =
                                `{{ route('admin.documents.update', '') }}/${this.formData.id}`; // Añade el ID al final
                        ...
                        if (response.status === 200) {
                            ...
                            const message = response.data?.message || (this.isEditing ?
                                'Documento actualizado exitosamente.' : 'Documento subido exitosamente.');
                            this.closeModal();
