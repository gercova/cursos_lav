...
@section('content')
    ...
    <div class="admin-enterprise ent-page">
        {{-- Hero --}}
        <div class="ent-hero">
            <div class="ent-hero-icon"><i class="bi bi-building"></i></div>
            <div>
        ...
        {{-- FORM PRINCIPAL --}}
        <form id="form-enterprise" action="{{ route('admin.enterprise.update') }}" method="POST"
            ...
            <div class="ent-tabs" role="tablist">
                ...
                <button type="button" class="ent-tab" data-tab="qr" role="tab">
                    <i class="bi bi-qr-code"></i> Compartir QR
                </button>
            </div>
            ...
            <div class="ent-panel active" id="panel-identidad">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-building"></i></div>
                    ...
                    <div class="ent-card-body">
                        <div class="grid-2">
                            <div class="field-group">
                                ...
                                <input type="text" name="ruc" class="ent-input" maxlength="11"
                                    value="{{ old('ruc', $enterprise->ruc ?? '') }}" placeholder="20123456789" required>
                                @error('ruc')
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="business_sector" class="ent-input"
                                    value="{{ old('business_sector', $enterprise->business_sector ?? '') }}"
                                    placeholder="Educación, Tecnología, Salud...">
                            </div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <input type="text" name="trade_name" class="ent-input"
                                value="{{ old('trade_name', $enterprise->trade_name ?? '') }}" placeholder="Mi Empresa"
                                required>
                            @error('trade_name')
                                <p class="field-error"><i class="bi bi-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-representante">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-person"></i></div>
                    ...
                    <div class="ent-card-body">
                        <div class="grid-2">
                            <div class="field-group">
                                ...
                                <input type="text" name="legal_representative_dni" class="ent-input" maxlength="8"
                        ...
                        <div class="field-group" style="margin-top:1.25rem;">
                            ...
                            @if ($rawSig && \Illuminate\Support\Facades\Storage::exists($rawSig))
                                <div class="current-img-row">
                                    <img src="{{ \Illuminate\Support\Facades\Storage::url($rawSig) }}"
                                        alt="Firma actual">
                                    <div class="current-img-label">
                                        <p><i class="bi bi-check-circle"
                                                style="color:#22c55e;margin-right:.25rem;"></i>Firma actual cargada</p>
                            ...
                            <div class="img-upload-zone" id="zone-sig">
                                ...
                                <div class="zone-icon"><i class="bi bi-signature"></i></div>
                            ...
                            <div class="js-preview-wrap" id="preview-sig">
                                <p class="js-preview-label"><i class="bi bi-eye" style="margin-right:.25rem;"></i>Vista
                                    previa de la nueva firma</p>
                                <img id="img-sig" src="" alt="Vista previa firma" class="sig-preview-box">
                            </div>

                            @error('signature_photo')
                                <p class="field-error" style="margin-top:.5rem;"><i
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-contacto">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-geo-alt"></i></div>
                        <h3>Información de Contacto y Ubicación</h3>
                    </div>
                    <div class="ent-card-body">
                        <div class="field-group">
                            <label class="field-label">Dirección <span class="badge-required">REQ</span></label>
                            <textarea name="address" class="ent-textarea" rows="2" required placeholder="Av. Principal 123, Urb. Centro">{{ old('address', $enterprise->address ?? '') }}</textarea>
                            @error('address')
                                <p class="field-error"><i class="bi bi-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid-2">
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="city" class="ent-input"
                                    value="{{ old('city', $enterprise->city ?? '') }}" placeholder="Lima" required>
                                @error('city')
                                    <p class="field-error"><i class="bi bi-exclamation-circle"></i>{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid-2">
                            <div class="field-group">
                                <label class="field-label">Teléfono Principal <span
                                        class="badge-required">REQ</span></label>
                        ...
                        <div class="field-group">
                            ...
                            <input type="email" name="email" class="ent-input"
                                value="{{ old('email', $enterprise->email ?? '') }}" placeholder="contacto@empresa.com"
                                required>
                            @error('email')
                                <p class="field-error"><i class="bi bi-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-visual">
                ...
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-image"></i></div>
                    ...
                    <div class="ent-card-body">
                        ...
                        @if ($logoRaw && \Illuminate\Support\Facades\Storage::exists($logoRaw))
                            <div class="current-img-row">
                                ...
                                <div class="current-img-label">
                                    <p><i class="bi bi-check-circle" style="color:#22c55e;margin-right:.25rem;"></i>Logo
                                        actual</p>
                            ...
                            --}}
                                <button type="submit" form="form-delete-logo" class="btn-delete-img"
                ...
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-star"></i></div>
                    ...
                    <div class="ent-card-body">
                        ...
                        @if ($faviRaw && \Illuminate\Support\Facades\Storage::exists($faviRaw))
                            <div class="current-img-row">
                                <img src="{{ \Illuminate\Support\Facades\Storage::url($faviRaw) }}" alt="Favicon actual"
                                    style="width:32px;height:32px;">
                                <div class="current-img-label">
                                    <p><i class="bi bi-check-circle"
                                            style="color:#22c55e;margin-right:.25rem;"></i>Favicon actual</p>
                                    <span>Se muestra en la pestaña del navegador</span>
                                </div>
                                {{-- form="form-delete-favicon" → apunta al <form> externo --}}
                                <button type="submit" form="form-delete-favicon" class="btn-delete-img"
                        ...
                        <div class="img-upload-zone" id="zone-fav">
                            ...
                            <div class="zone-icon"><i class="bi bi-star"></i></div>
                        ...
                        <div class="js-preview-wrap" id="preview-fav">
                            <p class="js-preview-label"><i class="bi bi-eye" style="margin-right:.25rem;"></i>Vista
                                previa del nuevo favicon</p>
                            <img id="img-fav" src="" alt="Vista previa favicon" class="img-preview-box"
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-contenido">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-align-left"></i></div>
                    ...
                    <div class="ent-card-body">
                        ...
                        <div class="field-group">
                            ...
                            <textarea name="description" class="ent-textarea" rows="4" placeholder="Breve descripción de la empresa...">{{ old('description', $enterprise->description ?? '') }}</textarea>
                        ...
                        <div class="grid-2">
                            <div class="field-group">
                                <label class="field-label">
                                    <i class="bi bi-rocket" style="color:#f59e0b;margin-right:.3rem;"></i>Misión
                                </label>
                                <textarea name="mission" class="ent-textarea" rows="5" placeholder="¿Qué hace tu empresa y para quién?">{{ old('mission', $enterprise->mission ?? '') }}</textarea>
                            </div>
                            <div class="field-group">
                                <label class="field-label">
                                    <i class="bi bi-eye" style="color:#8b5cf6;margin-right:.3rem;"></i>Visión
                                </label>
                                <textarea name="vision" class="ent-textarea" rows="5" placeholder="¿A dónde quieres llegar?">{{ old('vision', $enterprise->vision ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-redes">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-share-alt"></i></div>
                        ...
                        @php
                            $socials = [
                                'facebook_link' => [
                                    ...
                                    'color' => '#1877f2',
                                    'label' => 'Facebook',
                                    'ph' => 'https://facebook.com/tuempresa',
                                ],
                                'linkedin_link' => [
                                    'icon' => 'bi bi-linkedin',
                                    'color' => '#0a66c2',
                                    'label' => 'LinkedIn',
                                    'ph' => 'https://linkedin.com/company/tuempresa',
                                ],
                                'twitter_link' => [
                                    'icon' => 'bi bi-twitter',
                                    'color' => '#1da1f2',
                                    'label' => 'Twitter / X',
                                    'ph' => 'https://twitter.com/tuempresa',
                                ],
                                'instagram_link' => [
                                    'icon' => 'bi bi-instagram',
                                    'color' => '#e1306c',
                                    'label' => 'Instagram',
                                    'ph' => 'https://instagram.com/tuempresa',
                                ],
                                'whatsapp_link' => [
                                    'icon' => 'bi bi-whatsapp',
                                    'color' => '#25d366',
                                    'label' => 'WhatsApp',
                                    'ph' => 'https://wa.me/51999999999',
                                ],
                            ];
                        @endphp
                        <div style="display:grid;gap:1rem;">
                            @foreach ($socials as $field => $info)
                                <div class="field-group" style="margin-bottom:0;">
                                    ...
                                    @error($field)
                                        <p class="field-error" style="margin-top:.3rem;"><i
                                                class="bi bi-exclamation-circle"></i>{{ $message }}</p>
                                    @enderror
                                </div>
                            @endforeach
        ...
        ══════════════════════════════════════ --}}
            <div class="ent-panel" id="panel-qr">
                <div class="ent-card">
                    <div class="ent-card-header">
                        <div class="ent-card-header-icon"><i class="bi bi-qrcode"></i></div>
                    ...
                    <div class="ent-card-body">
                        <div class="grid-2">
                            ...
                            <div
                                style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 1rem; padding: 2rem; display: flex; flex-direction: column; align-items: center; justify-content: center; box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
                                <div id="qrcode-container"
                                    style="background-color: #ffffff; padding: 1.25rem; border-radius: 1rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06); border: 1px solid #cbd5e1; transition: transform 0.2s ease-in-out;"
                                    onmouseover="this.style.transform='scale(1.03)'"
                                    onmouseout="this.style.transform='scale(1)'">
                                    <div id="qrcode"
                                        style="display: flex; justify-content: center; align-items: center; min-width: 200px; min-height: 200px;">
                                    </div>
                                </div>

                                <div
                                    style="margin-top: 1.5rem; display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: center; width: 100%;">
                                    <button type="button" id="btn-download-qr" class="btn-save"
                                        style="background: linear-gradient(135deg, #2563eb, #1d4ed8); padding: 0.6rem 1.2rem; font-size: 0.82rem; box-shadow: 0 4px 10px rgba(37, 99, 235, 0.2);">
                                        <i class="bi bi-download"></i> Descargar Imagen
                                    </button>
                                    <button type="button" id="btn-share-qr" class="btn-save"
                                        style="background: linear-gradient(135deg, #0d9488, #0f766e); padding: 0.6rem 1.2rem; font-size: 0.82rem; box-shadow: 0 4px 10px rgba(13, 148, 136, 0.2);">
                                        <i class="bi bi-share-alt"></i> Compartir QR
                                    </button>
                                    <button type="button" id="btn-copy-link" class="btn-cancel"
                                        style="padding: 0.55rem 1.2rem; font-size: 0.82rem;">
                            ...
                            <div
                                style="display: flex; flex-direction: column; justify-content: space-between; gap: 1.5rem;">
                                <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                    <h4
                                        style="font-weight: 700; color: #334155; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.25rem;">
                                        Información a incluir en el QR:</h4>

                                    <label
                                        style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 1rem; bg-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 0.75rem; cursor: pointer; transition: background-color 0.15s;"
                                        onmouseover="this.style.backgroundColor='#f8fafc'"
                                        onmouseout="this.style.backgroundColor='#ffffff'">
                                        <input type="checkbox" id="chk-trade-name" checked
                                            style="width: 1.1rem; height: 1.1rem; accent-color: #1d4ed8;">
                                        <div>
                                            <p style="font-size: 0.85rem; font-weight: 600; color: #0f172a; margin: 0;">
                                                Nombre Comercial</p>
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                                {{ $enterprise->trade_name ?? 'No especificado' }}</p>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <div>
                                            <p style="font-size: 0.85rem; font-weight: 600; color: #0f172a; margin: 0;">
                                                Enlace de la Plataforma</p>
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">{{ url('/') }}
                                            </p>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        onmouseover="this.style.backgroundColor='#f8fafc'"
                                        onmouseout="this.style.backgroundColor='#ffffff'">
                                        <input type="checkbox" id="chk-ruc"
                                            style="width: 1.1rem; height: 1.1rem; accent-color: #1d4ed8;">
                                        <div>
                                            <p style="font-size: 0.85rem; font-weight: 600; color: #0f172a; margin: 0;">RUC
                                            </p>
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                                {{ $enterprise->ruc ?? 'No especificado' }}</p>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <div>
                                            ...
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                                {{ $enterprise->email ?? 'No especificado' }}</p>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <div>
                                            <p style="font-size: 0.85rem; font-weight: 600; color: #0f172a; margin: 0;">
                                                Teléfono</p>
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                                {{ $enterprise->phone_number_1 ?? 'No especificado' }}</p>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <div>
                                            <p style="font-size: 0.85rem; font-weight: 600; color: #0f172a; margin: 0;">
                                                Dirección y Ciudad</p>
                                            <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                                {{ $enterprise->address ?? '' }}, {{ $enterprise->city ?? '' }}</p>
                                        </div>
                                    </label>
                                </div>
                                ...
                                <div
                                    style="background-color: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 0.75rem; padding: 1rem;">
                                    <span
                                        style="font-size: 0.7rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; display: block;">Texto
                                        codificado en el QR:</span>
                                    <pre id="qr-text-preview"
                                        style="margin-top: 0.35rem; font-size: 0.75rem; color: #334155; white-space: pre-wrap; font-family: monospace; line-height: 1.4;"></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div style="display:flex;align-items:center;gap:.5rem;">
                    <div class="tab-progress">
                        @foreach (['identidad', 'representante', 'contacto', 'visual', 'contenido', 'redes', 'qr'] as $tp)
                            <div class="tab-dot {{ $tp === 'identidad' ? 'active' : '' }}"
                                data-dot="{{ $tp }}"></div>
                        @endforeach
                    </div>
                    <span style="font-size:.78rem;color:var(--brand-muted);margin-left:.5rem;">Completa todos los
                        campos</span>
                </div>
    ...
    <script>
        (function() {
            ...
            function updateQR() {
                ...
                if (!qrText) {
                    container.innerHTML =
                        '<span style="color:#94a3b8; font-size:0.85rem; text-align:center;">Selecciona al menos un campo</span>';
                    return;
                }
            ...
            if (btnCopy) {
                btnCopy.addEventListener('click', () => {
                    ...
                    navigator.clipboard.writeText(linkVal).then(() => {
                        ...
                        btnCopy.innerHTML =
                            '<i class="bi bi-check" style="color:#22c55e;"></i> ¡Copiado!';
            ...
            if (btnShare) {
                btnShare.addEventListener('click', () => {
                    ...
                    if (canvas && navigator.share && navigator.canShare && HTMLCanvasElement.prototype.toBlob) {
                        canvas.toBlob(blob => {
                            const file = new File([blob], 'qr-empresa.png', {
                                type: 'image/png'
                            });
                        ...
                        navigator.clipboard.writeText(qrText).then(() => {
                            ...
                            btnShare.innerHTML =
                                '<i class="bi bi-check" style="color:#22c55e;"></i> ¡Copiado al portapapeles!';
                            setTimeout(() => {
