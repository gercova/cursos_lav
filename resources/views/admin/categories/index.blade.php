...
@section('content')
    <div class="container mx-auto px-4 py-6" x-data="categoryManager()" x-init="init()">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden md:overflow-visible border border-gray-200">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <div class="relative flex-1">
                            ...
                            <input type="text" name="search" id="searchCategory" x-model="searchQuery"
                                @input.debounce.400ms="performSearch()" placeholder="Buscar categorías..."
            ...
            <!-- Tabla Container -->
            <div id="categories-table-container" class="overflow-x-auto md:overflow-visible" x-show="!loading">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($categories as $category)
                                <tr class="hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-white transition-all duration-200 group" data-category-id="{{ $category->id }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-200">
                                        ...
                                        <div class="relative flex items-center justify-end">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <button @click="toggleStatus({{ $category->id }}); open = false"
                                                    ...
                                                    {{ $category->is_active ? 'text-amber-600 hover:bg-amber-50' : 'text-emerald-600 hover:bg-emerald-50' }}
                                                ...
                                                <button @click="deleteCategory({{ $category->id }}); dropdownOpen = false"
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @foreach ($categories->getUrlRange(max(1, $categories->currentPage() - 2), min($categories->lastPage(), $categories->currentPage() + 2)) as $page => $url)
                                @if ($page == $categories->currentPage())
                                    <span
                                        class="px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium">
                                        {{ $page }}
                                    </span>
                                @else
                                    <a href="{{ $url }}"
        ...
        function categoryManager() {
            return {
                ...
                async performSearch() {
                    ...
                    const displayUrl =
                        `{{ route('admin.categories.index') }}?${params.toString().replace('&ajax=1','').replace('ajax=1&','').replace('ajax=1','')}`;
                ...
                async handleModalSubmit(detail) {
                    ...
                    try {
                        ...
                        const response = await axios({
                            ...
                            url: isEditing ? `${API_URL}/admin/categories/${categoryId}` :
                                `${API_URL}/admin/categories/store`,
                            data: dataObject,
                            headers: {
                ...
                showNotification(message, type = 'success') {
                    ...
                    notification.className =
                        `fixed top-6 right-6 z-50 px-6 py-4 rounded-xl shadow-xl transform transition-all duration-300 ${bgClass} text-white`;
