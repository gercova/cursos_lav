...
@section('content')
    <div class="container mx-auto px-4 py-6" x-data="courseManager()" x-init="init()">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-900 mt-1">
                                {{ $courses->where('is_active', true)->count() }}</p>
                        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            ...
            <!-- Tabla de cursos -->
            <div class="overflow-x-auto md:overflow-visible" id="courses-table-container" x-show="!loading">
                @if ($courses->isEmpty())
                    <!-- Estado vacío -->
                    <div class="text-center py-16 px-6">
                        ...
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Comienza creando tu primer curso para la plataforma.
                        </p>
                        <a href="{{ route('admin.courses.create') }}"
                                ...
                                <tr class="hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-white transition-all duration-200 group"
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="flex-shrink-0">
                                                ...
                                                @else
                                                    <div
                                                        class="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                                    ...
                                                    @if ($course->is_on_promotion)
                                                        <span
                                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800">
                                    ...
                                    <td class="px-6 py-5">
                                        <div x-data="{ open: false }" class="relative flex items-center justify-end">
                                            <!-- Botón del menú desplegable (tres puntos verticales) -->
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-10 origin-top-right"
                                                ...
                                                <!-- Cambiar estado -->
                                                <button @click="toggleCourseStatus({{ $course->id }}); open = false"
                                                    class="w-full text-left px-4 py-2 text-sm flex items-center gap-2 hover:bg-{{ $course->is_active ? 'amber' : 'green' }}-50 text-{{ $course->is_active ? 'amber' : 'green' }}-600">
                                                    @if ($course->is_active)
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <button
                                                    @click="$dispatch('open-price-modal', { id: {{ $course->id }}, title: '{{ $course->title }}', price: {{ $course->price }}, promo: {{ $course->promotion_price ?? 0 }} }); open = false"
                                                ...
                                                <a href="{{ route('admin.courses.edit', $course) }}"
                                                    class="block px-4 py-2 text-sm text-blue-600 hover:bg-blue-50 flex items-center gap-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                <button @click="deleteCourse({{ $course->id }}); open = false"
        ...
        <div x-data="{
            ...
            <!-- Modal overlay -->
            <div x-show="showSections" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                ...
                <div class="flex items-center justify-center min-h-screen p-4">
                    <div x-show="showSections" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                            ...
                            <div
                                class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                                ...
                                <form @submit.prevent="addSection" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" x-model="newSectionTitle" required
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Orden</label>
                                            <input type="number" x-model="newSectionOrder" min="1"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Descripción</label>
                                        <textarea x-model="newSectionDescription" rows="2"
                            ...
                            <div x-show="!loadingSections && sections.length > 0">
                                ...
                                <div class="space-y-4">
                                    <template x-for="(section, index) in sections" :key="section.id">
                                        <div
                                            class="p-4 border border-gray-200 rounded-xl hover:border-blue-300 transition duration-200">
                                            <div class="flex items-center justify-between mb-2">
                                                <div class="flex items-center gap-3">
                                                    <span
                                                        class="flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 font-bold"
                                            ...
                                            <p class="text-sm text-gray-600 ml-11"
                                                x-text="section.description || 'Sin descripción'"></p>
                                        </div>
                                    </template>
                                </div>
                            </div>
                            ...
                            <div x-show="!loadingSections && sections.length === 0" class="text-center py-8">
                                <div
                                    class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 mb-4">
                            ...
                            <div x-show="loadingSections" class="text-center py-8">
                                <div
                                    class="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-blue-600 mb-4">
                                </div>
        ...
        <div x-show="priceModal.show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
        ...
        ">
            <div class="flex items-center justify-center min-h-screen p-4 text-center">
                <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" @click="priceModal.show = false">
                </div>

                <div
                    class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 transform transition-all border border-gray-100">
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        <button @click="priceModal.show = false"
                            class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-xl transition font-medium">
                            Cancelar
                        </button>
                        <button @click="savePrices()" :disabled="priceModal.loading || isPriceInvalid"
                            ...
                            <span x-show="priceModal.loading"
        ...
        function courseManager() {
            return {
                ...
                async performSearch() {
                    ...
                    const displayUrl =
                        `{{ route('admin.courses.index') }}?${params.toString().replace('&ajax=1','').replace('ajax=1&','').replace('ajax=1','')}`;
