...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Total Estudiantes -->
            <div
                class="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl shadow-lg p-5 transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-3">
                            <span class="text-xs bg-blue-700 px-2 py-1 rounded-full">
                                <i class="bi bi-mortarboard mr-1"></i>Activos: {{ $stats['active_students_week'] }}
                            </span>
                        </div>
                    </div>
            ...
            <!-- Total Cursos -->
            <div
                class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl shadow-lg p-5 transform hover:scale-105 transition-transform duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-3">
                            <span class="text-xs bg-green-700 px-2 py-1 rounded-full">
                                <i class="bi bi-star mr-1"></i>Rating: {{ number_format($stats['avg_course_rating'], 1) }}/5
                            </span>
                        </div>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
            ...
            <!-- Exámenes -->
            <div
                class="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl shadow-lg p-5 transform hover:scale-105 transition-transform duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2 mt-3">
                            <span class="text-xs bg-purple-700 px-2 py-1 rounded-full text-center">
                                <i class="bi bi-check-circle mr-1"></i>{{ $stats['completed_exams'] }}
                            </span>
                            <span class="text-xs bg-purple-800 px-2 py-1 rounded-full text-center">
                                <i class="bi bi-x mr-1"></i>{{ $stats['failed_exams'] }}
                            </span>
                        </div>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
            ...
            <!-- Ingresos Mensuales -->
            <div
                class="bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl shadow-lg p-5 transform hover:scale-105 transition-transform duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-3">
                            <span class="text-xs bg-orange-700 px-2 py-1 rounded-full">
                                <i class="bi bi-graph-up mr-1"></i>Semanal: S/
                                {{ number_format($stats['weekly_revenue'], 2) }}
                            </span>
                        </div>
                    </div>
                    <div class="bg-white bg-opacity-20 p-3 rounded-full">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <i class="bi bi-calendar-day text-green-500 mr-2"></i>
            ...
            <div class="bg-white rounded-xl shadow-lg p-5 border border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-blue-100 p-3 rounded-full">
                        <i class="bi bi-person-square text-blue-600 text-xl"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-5 border border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <i class="bi bi-patch-check text-yellow-500 mr-2"></i>
                            <span class="text-sm text-gray-500">Emitidos</span>
                        </div>
                    </div>
                    <div class="bg-yellow-100 p-3 rounded-full">
                        <i class="bi bi-patch-check text-yellow-600 text-xl"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-5 border border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <i class="bi bi-clock text-red-500 mr-2"></i>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="text-sm text-blue-600 font-medium">
                        <i class="bi bi-bar-chart-fill mr-2"></i>Gráfico de Barras
                    </div>
                </div>
                <div class="h-80">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="text-sm text-green-600 font-medium">
                        <i class="bi bi-bar-chart-steps mr-2"></i>Gráfico de Barras Horizontal
                    </div>
                </div>
                <div class="h-80">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="text-sm text-purple-600 font-medium">
                        <i class="bi bi-cash-stack mr-2"></i>Tendencia de Ingresos
                    </div>
                </div>
                <div class="h-80">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="space-y-4 max-h-80 overflow-y-auto pr-2">
                    @foreach ($recentEnrollments as $enrollment)
                        <div
                            class="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 border border-gray-100">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500 truncate">
                                    <i class="bi bi-book mr-1"></i>{{ Str::limit($enrollment->course->title, 30) }}
                                </p>
                                <p class="text-xs text-gray-400 mt-1">
                                    <i class="bi bi-clock mr-1"></i>{{ $enrollment->enrolled_at->diffForHumans() }}
                                </p>
                            </div>
                ...
                <a href="{{ route('admin.enrollments.index') }}"
                    class="block text-center mt-4 text-sm text-blue-600 hover:text-blue-700 font-medium">
                    <i class="bi bi-list-check mr-1"></i>Ver todas las inscripciones
                </a>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="space-y-4">
                    @foreach ($popularCourses as $course)
                        <div
                            class="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 border border-gray-100">
                ...
                <a href="{{ route('admin.courses.index') }}"
                    class="block text-center mt-4 text-sm text-blue-600 hover:text-blue-700 font-medium">
                    <i class="bi bi-book mr-1"></i>Gestionar todos los cursos
                </a>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('admin.courses.create') }}"
                        class="p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl hover:from-blue-100 hover:to-blue-200 transition-all duration-300 group border border-blue-200">
                        <div class="text-center">
                            <div
                                class="bg-white p-3 rounded-lg inline-flex group-hover:bg-blue-50 transition-colors duration-200 shadow-sm">
                                <i class="bi bi-plus text-blue-600 text-xl"></i>
                            </div>
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-300 group border border-green-200">
                        <div class="text-center">
                            <div
                                class="bg-white p-3 rounded-lg inline-flex group-hover:bg-green-50 transition-colors duration-200 shadow-sm">
                    ...
                    <a href="{{ route('admin.payments.index') }}"
                        class="p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 group border border-purple-200">
                        <div class="text-center">
                            <div
                                class="bg-white p-3 rounded-lg inline-flex group-hover:bg-purple-50 transition-colors duration-200 shadow-sm">
                    ...
                    <a href="{{ route('admin.reports') }}"
                        class="p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl hover:from-orange-100 hover:to-orange-200 transition-all duration-300 group border border-orange-200">
                        <div class="text-center">
                            <div
                                class="bg-white p-3 rounded-lg inline-flex group-hover:bg-orange-50 transition-colors duration-200 shadow-sm">
                                <i class="bi bi-bar-chart-steps text-orange-600 text-xl"></i>
                            </div>
            ...
            function animateCounters() {
                ...
                counters.forEach(counter => {
                    ...
                    const timer = setInterval(() => {
                        ...
                        if (isMoney) {
                            counter.textContent = 'S/ ' + current.toLocaleString('es-PE', {
