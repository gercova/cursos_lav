                ...
                <div class="bg-white rounded-xl shadow-md p-4 sm:p-5 sticky top-24 border border-gray-100">
                    ...
                    <nav class="index-nav">
                        <ul class="space-y-1 text-sm text-gray-600">
                            <li><a href="#section-1" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">1. Aceptación de Términos</a></li>
                            <li><a href="#section-2" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">2. Servicios Ofrecidos</a></li>
                            <li><a href="#section-3" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">3. Registro de Usuario</a></li>
                            <li><a href="#section-4" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">4. Protección de Datos</a></li>
                            <li><a href="#section-5" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">5. Propiedad Intelectual</a></li>
                            <li><a href="#section-6" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">6. Responsabilidades</a></li>
                            <li><a href="#section-7" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">7. Modificaciones</a></li>
                            <li><a href="#section-8" class="block py-2 px-3 border-l-4 border-transparent hover:bg-gray-50 hover:text-blue-600 transition-all rounded-r-md">8. Ley Aplicable</a></li>
                        </ul>
                    </nav>
                </div>
            </aside>
                    ...
                    <div class="px-4 sm:px-8 py-6 sm:py-8">
                        ...
                        <section id="section-4" class="mb-8 sm:mb-10 scroll-mt-24">
                            <div class="flex items-start sm:items-center mb-4 sm:mb-6">
                                ...
                                <h2 class="text-xl sm:text-2xl font-bold text-gray-900 flex flex-col sm:flex-row sm:items-center">
                                    ...
                                    <span class="text-sm sm:text-lg text-green-600 sm:ml-2 mt-1 sm:mt-0">(Ley N° 29733)</span>
                                </h2>
                            </div>
                            <div class="pl-0 sm:pl-14">
                                ...
                                <h3 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4">4.1 Principios y Datos Recopilados</h3>
                                <p class="text-sm sm:text-base text-gray-700 mb-4">
                                    Recolectamos datos de identificación, contacto y académicos única y exclusivamente para la correcta ejecución del servicio educativo y verificación de certificados, bajo su consentimiento expreso.
                                </p>
                            </div>
                        </section>
                        ...
                        <section id="section-8" class="mb-8 sm:mb-10 scroll-mt-24">
                            <div class="flex items-center mb-4 sm:mb-6">
                                ...
                                <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Ley Aplicable y Jurisdicción</h2>
                            </div>
                            <div class="pl-0 sm:pl-14">
                                <p class="text-sm sm:text-base text-gray-700 mb-4">
