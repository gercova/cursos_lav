    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <p class="font-semibold">
                        <span
                            class="px-2 py-1 rounded-full text-xs {{ $course->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <div class="border border-gray-200 rounded-lg hover:shadow-lg transition-shadow duration-200">
                        <div class="p-5">
                            ...
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <span
                                    class="px-2 py-1 rounded-full text-xs {{ $exam->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                ...
                                @if (($exam->attempts_count ?? 0) > 0)
                                    <div class="mt-2">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">
                                            Tasa de aprobación:
                                            {{ number_format((($exam->passed_count ?? 0) / ($exam->attempts_count ?? 1)) * 100, 1) }}%
                                        </p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('admin.exams.edit', $exam) }}"
                                    ...
                                    <i class="bi bi-edit mr-1"></i> Editar
                                </a>
                                <a href="{{ route('admin.exams.questions', $exam) }}"
                                    ...
                                    <i class="bi bi-question-circle mr-1"></i> Preguntas
                                </a>
                                <a href="{{ route('admin.exams.results', $exam) }}"
                                    ...
                                    <i class="bi bi-bar-chart mr-1"></i> Resultados
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                <div class="mb-4">
                    <i class="bi bi-clipboard-list text-6xl text-gray-300"></i>
                </div>
