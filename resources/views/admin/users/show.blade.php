...
<div x-data="userProfile()" class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
            <div class="p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 text-center">
                <div class="text-2xl font-extrabold text-blue-900">{{ $user->enrollments_count ?? 0 }}</div>
            ...
            <div class="p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200 text-center">
                <div class="text-2xl font-extrabold text-green-900">{{ $user->courses_count ?? 0 }}</div>
            ...
            <div class="p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200 text-center">
                <div class="text-2xl font-extrabold text-yellow-900">{{ $user->certificates_count ?? 0 }}</div>
            ...
            <div class="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 text-center">
                <div class="text-2xl font-extrabold text-purple-900">{{ $user->exam_attempts_count ?? 0 }}</div>
            ...
            <nav class="flex overflow-x-auto">
                ...
                <button @click="activeTab = 'enrollments'"
                    ...
                    <span class="ml-1 px-2 py-0.5 rounded-full text-xs font-bold
                        {{ 'bg-blue-100 text-blue-700' }}">{{ $user->enrollments_count ?? 0 }}</span>
                </button>
                <button @click="activeTab = 'certificates'"
                    ...
                    <span class="ml-1 px-2 py-0.5 rounded-full text-xs font-bold bg-yellow-100 text-yellow-700">{{ $user->certificates_count ?? 0 }}</span>
                </button>
                <button @click="activeTab = 'exams'"
                    ...
                    <span class="ml-1 px-2 py-0.5 rounded-full text-xs font-bold bg-orange-100 text-orange-700">{{ $user->exam_attempts_count ?? 0 }}</span>
                </button>
