                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address"
                                      id="address"
                                      rows="2"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">{{ old('address', $user->address) }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200 shadow-sm">
                ...
                <div class="space-y-3">
                    <button onclick="toggleUserStatus({{ $user->id }})"
                        ...
                        <div class="p-2 rounded-lg bg-gradient-to-br {{ $user->status === 'active' ? 'from-red-100 to-red-200' : 'from-green-100 to-green-200' }}">
                            <svg class="w-5 h-5 {{ $user->status === 'active' ? 'text-red-600' : 'text-green-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
