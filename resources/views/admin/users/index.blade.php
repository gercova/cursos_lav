...
@section('content')
    <div class="container mx-auto px-4 py-6" x-data="userManager()" x-init="init()">
                                                ...
                                                <div class="flex items-center gap-3 mt-2 text-xs text-gray-400">
                                                    ...
                                                    @if ($user->expires_at)
                                                        <div class="flex items-center gap-1 text-amber-600 font-semibold"
                                                            ...
                                                            Expira: {{ $user->expires_at->format('d/m/Y') }}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-purple-600">{{ $user->courses_count }}</span>
                                            </div>
                                            <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span
                                                    class="text-xs font-semibold text-orange-600">{{ $user->exam_attempts_count }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5">
                                        <div x-data="{ open: false }" class="relative flex items-center justify-end">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <!-- Botón modal cambiar fecha de expiración -->
                                                <button
                                                    ...
                                                    <i class="bi bi-calendar"></i> F. expiración
                                                </button>
                                                ...
                                                @if ($user->code)
                                                    <button onclick="copyPromoLink('{{ $user->code }}', this)"
                                                        ...
                                                        <i class="bi bi-share-fill"></i> Copiar enlace
                                                    </button>
                                                @endif
                                                ...
                                                @if ($user->code == null)
                                                    @if ($user->role !== 'business')
                                                        <button
                                                            ...
                                                            <i class="bi bi-upc"></i> Crear código
                                                        </button>
                                                    @endif
                                                @endif
                                    ...
                                    <div
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="mt-2 text-xs font-medium text-red-500 flex items-center gap-1"
                                                ...
                                                x-transition>
                                                <i class="bi bi-exclamation-triangle-fill"></i> Las contraseñas no
                                                coinciden
                                            </div>
                                        </div>
                                    </div>
        ...
        <div x-data="expirationModal()" x-on:open-expiration-modal.window="handleOpen($event.detail)" x-show="showModal"
            style="display: none;">
            <!-- Modal overlay -->
            <div x-show="showModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200"
                ...
                <div class="flex items-center justify-center min-h-screen p-4">
                    <div x-show="showModal" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">Actualizar expiración</h3>
                                </div>
                                <button @click="closeModal"
                                    class="p-2 hover:bg-gray-100 rounded-lg transition duration-200">
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor"
                                ...
                                <div class="space-y-6">
                                    <div
                                        ...
                                        <p class="text-sm text-gray-600 mb-4">
                                            Establece la fecha en que la cuenta del usuario caducará. Deja la fecha en
                                            blanco si deseas que el usuario tenga acceso ilimitado.
                                        </p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" x-model="formData.expires_at"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="number" step="0.01" x-model="formData.quantity"
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">
                                        </div>
                                    </div>
                                </div>
            ...
            return {
                ...
                async submitExpiration() {
                    if (!this.formData.expires_at) {
                        showNotification('La fecha de expiración es requerida', 'error');
                        return;
                    }

                    const parsedDate = Date.parse(this.formData.expires_at);
                    if (isNaN(parsedDate)) {
                        showNotification('Por favor, ingrese una fecha válida', 'error');
                        return;
                    }
                    ...
                    try {
                        ...
                        const message = error.response?.data?.message || error.response?.data?.errors?.expires_at?.[
                            0
                        ] || 'Error al actualizar la fecha de expiración';
                        showNotification(message, 'error');
                    } finally {
                        this.isSubmitting = false;
                    }
