...
@section('content')
    <div class="bg-white rounded-lg shadow-sm">
        <div
            class="border-b border-gray-200 p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <div class="mt-2 flex items-center gap-2">
                    <span
                        ...
                        <i class="bi bi-person mr-1"></i> Total: <span id="totalStudentsCounter"
                            class="ml-1 mr-1">{{ $enrollments->total() }}</span> alumnos
                    </span>
                </div>
            </div>
            <div>
        ...
        <div class="p-6 border-b border-gray-200 bg-gray-50">
            <div class="flex flex-col sm:flex-row gap-4">
                <div class="relative flex-1 max-w-lg">
                    <input type="text" id="searchInput" placeholder="Buscar por nombre, email o DNI..."
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            Contacto</th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha
                            Inscripción</th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            Progreso</th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Estado
                        </th>
                    </tr>
                </thead>
