            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div
                            class="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl">
                            @if ($course->image_url)
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-900 mt-1">
                                {{ $sections->where('is_active', true)->count() }}</p>
                        </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex gap-2">
                        <select x-model="statusFilter" @change="filterSections()"
            ...
            <div class="overflow-x-auto">
                @if ($sections->isEmpty())
                    ...
                    <div class="text-center py-16 px-6">
                        ...
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Comienza creando la primera sección para este curso.
                        </p>
                        <a href="{{ route('admin.courses.sections.create', $course) }}"
                ...
                @else
                    <div x-ref="sectionsContainer" class="min-w-full">
                        <template x-for="section in filteredSections" :key="section.id">
                            <div
                                class="border-b border-gray-100 last:border-b-0 hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-white transition-all duration-200">
                                <div class="px-6 py-5">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <span
                                                        class="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 text-blue-700 font-bold text-lg"
                                                    ...
                                                    <div class="flex flex-wrap gap-4 text-sm text-gray-500">
                                                        ...
                                                        <div class="flex items-center gap-2" x-show="section.media_url">
                                                            <template x-if="section.media_type === 'video'">
                                                                <div class="flex items-center gap-1">
                                                                    <i class="bi bi-video text-purple-500"></i>
                                                                    <span>Video incluido</span>
                                                                </div>
                                                            </template>
                                                            <template x-if="section.media_type === 'image'">
                                                                <div class="flex items-center gap-1">
                                                                    <i class="bi bi-image text-green-500"></i>
                                                            ...
                                                            <a :href="section.media_url" target="_blank"
                                                        ...
                                                        <!-- Número de lecciones -->
                                                        <div class="flex items-center gap-1">
                                                            <i class="bi bi-list-ol text-indigo-500"></i>
                                                            <span
                                                                x-text="`${section.lessons_count || 0} lecciones`"></span>
                                                        </div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button @click="toggleSectionStatus(section)"
                                                ...
                                                <template x-if="section.is_active">
                                                    ...
                                                    <i class="bi bi-power w-5 h-5"></i>
                                                </template>

                                                <template x-if="!section.is_active">
                                                    <!-- Play/activar -->
                                                    <i class="bi bi-play w-5 h-5"></i>
                                                </template>
                                            </button>
        ...
        <div x-show="showDeleteModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div x-show="showDeleteModal" x-transition:enter="ease-out duration-300"
                    ...
                    x-transition:leave-end="opacity-0 scale-95" class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 rounded-full bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1"
                                    x-text="sectionToDelete ? 'Se eliminará: ' + sectionToDelete.title : ''"></p>
                            </div>
                        </div>

                        <p class="text-sm text-gray-600 mb-4">
                            Esta acción eliminará la sección y todas sus lecciones asociadas. Esta acción no se puede
                            deshacer.
                        </p>
                    </div>
            ...
            return {
                ...
                async toggleSectionStatus(section) {
                    try {
                        const response = await axios.post(
                            `/admin/courses/${section.course_id}/sections/${section.id}/toggle-status`, {
                                _token: '{{ csrf_token() }}'
                            });
                ...
                async confirmDelete() {
                    ...
                    try {
                        ...
                        const url =
                            `/admin/courses/${this.sectionToDelete.course_id}/sections/${this.sectionToDelete.id}`;
