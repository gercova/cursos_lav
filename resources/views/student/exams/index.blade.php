                        ...
                        <div class="p-6">
                            ...
                            <div class="flex space-x-3">
                                <a href="{{ route('student.exams.show', $exam->id) }}"
                                   class="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium py-3 px-4 rounded-lg text-center transition-all duration-200 transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-3">
                                    <div class="h-3 rounded-full {{ $isPassed ? 'bg-emerald-500' : 'bg-rose-500' }}"
                                         style="width: {{ min($percentage, 100) }}%"></div>
                                </div>

                                <div class="flex justify-between text-sm text-gray-500 mt-1">
                                    <span>0%</span>
                                    <span class="font-medium">Puntaje mínimo: {{ $exam->passing_score }} pts</span>
                                    <span>100%</span>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                ...
                                <div class="text-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="text-xs text-gray-500">Intento</div>
                                </div>
                                <div class="text-center p-3 bg-gray-50 rounded-lg">
                                    <div class="text-lg font-bold text-gray-900">{{ $exam->max_attempts == 0 ? '∞' : $exam->max_attempts }}</div>
                                    <div class="text-xs text-gray-500">Intentos máx.</div>
                                </div>
                            </div>
                            ...
                            <div class="flex space-x-3">
                                <a href="{{ route('student.exams.view', $attempt->id) }}"
                                   class="flex-1 bg-gray-800 hover:bg-gray-900 text-white font-medium py-3 px-4 rounded-lg text-center transition-all duration-200 transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center">
                                ...
                                @if($exam->can_retake)
                                <a href="{{ route('student.exams.show', $exam->id) }}"
                                   class="flex-1 border border-blue-500 text-blue-600 hover:bg-blue-50 font-medium py-3 px-4 rounded-lg text-center transition-all duration-200 transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center">
